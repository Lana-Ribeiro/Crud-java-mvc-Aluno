    ...
    <body>
        ...
        <nav>
            <div class="menu">
                ...
                <div class="submenu">
                    <a href="cadAluno.html" target="centro">Cadastro</a>
                    <a href="condep.html" target="centro">Consulta</a>
                    <a href="altAluno.html" target="centro">Alteração</a>
                    <a href="excaluno.html" target="centro">Exclusão</a>
                     <a href="ControleAluno?flag=list_Aluno">Listar</a>
                </div>
            </div>    
        </nav>
        <main>
